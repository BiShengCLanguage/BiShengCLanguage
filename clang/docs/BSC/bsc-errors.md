...
| MISC-008 | err_bsc_generic_variable | generic variable `%0` is not supported; generic parameters can only be applied to functions, structs, unions and typealiases | — |
